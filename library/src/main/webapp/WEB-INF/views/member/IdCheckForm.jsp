...
<body  onload="pValue()">
	<div  id="wrap">
		...
		<div  id="chk">
			...
			        
			<div  id="msg"></div>
			        <br>        <input  id="cancelBtn"  type="button"
				 value="취소"  onclick="window.close()"><br>        <input
